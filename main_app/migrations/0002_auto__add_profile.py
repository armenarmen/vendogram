...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_app_profile', (
            ...
            ('bio', self.gf('django.db.models.fields.CharField')(max_length=2200, null=True, blank=True)),
            ...
            ('instagram_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
