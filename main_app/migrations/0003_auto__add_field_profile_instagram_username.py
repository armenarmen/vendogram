...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.instagram_username'
        db.add_column(u'main_app_profile', 'instagram_username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.instagram_username'
        db.delete_column(u'main_app_profile', 'instagram_username')
    ...
    models = {
        ...
        u'main_app.profile': {
            ...
            'instagram_username': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
